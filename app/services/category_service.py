...
def add_category(
    ...
    if "trendyol.com" not in normalized_url.lower():
        return (
            False,
            "Yalnızca Trendyol kategori bağlantısı eklenebilir.",
            None,
        )
    ...
    with _file_lock:
        ...
        if url is not None:
            ...
            if "trendyol.com" not in normalized_url.lower():
                return (
                    False,
                    "Yalnızca Trendyol kategori bağlantısı kullanılabilir.",
                    None,
                )
