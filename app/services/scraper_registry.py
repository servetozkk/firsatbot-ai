...
from app.scrapers.retail_stores import (
    CicekSepetiScraper,
    GamingGenScraper,
    IdefixScraper,
    IncehesapScraper,
...
STORE_SCRAPER_DEFINITIONS: tuple[
    ...
    StoreScraperDefinition(
        ...
        scraper_class=CicekSepetiScraper,
        enabled=True,
    ),
    StoreScraperDefinition(
        code="teknosa",
    ...
    StoreScraperDefinition(
        ...
        scraper_class=GamingGenScraper,
        enabled=True,
    ),
)
...
class ScraperRegistry:
    ...
    def __init__(self) -> None:
        self._definitions_by_code = {
            ...
            for definition in STORE_SCRAPER_DEFINITIONS
        }
