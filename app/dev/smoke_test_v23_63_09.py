...
checks=[
 ('VERSION 23.63.09',(ROOT/'VERSION').read_text().strip()=='23.63.09'),
 ('runtime endpoint v236309','/api/runtime-identity/v236309' in main),
 ('soak endpoint v236309','/api/runtime-soak-stability/v236309' in main),
 ('force response v236309','"runtime_version": _RUNTIME_VERSION_V236309' in main),
...
if failed: raise SystemExit('V23.63.09 MASTER smoke FAIL: '+', '.join(failed))
print(f'V23.63.09 MASTER smoke OK {len(checks)}/{len(checks)}')
