...
checks=[
 ('VERSION 23.63.12',(ROOT/'VERSION').read_text().strip()=='23.63.12'),
 ('VERSION.txt 23.63.12',(ROOT/'VERSION.txt').read_text().strip()=='23.63.12'),
 ('runtime constant v236312','_RUNTIME_VERSION_V236312 = "23.63.12"' in main),
 ('runtime endpoint v236312','/api/runtime-identity/v236312' in main),
 ('soak endpoint v236312','/api/runtime-soak-stability/v236312' in main),
 ('force response exact v236312','"runtime_version": _RUNTIME_VERSION_V236312,\n            "test_only": True' in main),
...
if failed: raise SystemExit('V23.63.12 MASTER smoke FAIL: '+', '.join(failed))
print(f'V23.63.12 MASTER smoke OK {len(checks)}/{len(checks)}')
