...
def main() -> int:
    ...
    ok(version == "11.4.0", "VERSION 11.4.0")
    ...
    ok("global_product_router" in main_text, "global ürün router main.py içine bağlandı")
    ...
    print("\nFırsatAI v11.4.0 Global Ürün Deneyimi smoke test başarılı.")
    return 0
