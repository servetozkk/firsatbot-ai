...
checks=[
 ('VERSION 23.63.21',(ROOT/'VERSION').read_text().strip()=='23.63.21'),
 ('VERSION.txt 23.63.21',(ROOT/'VERSION.txt').read_text().strip()=='23.63.21'),
 ('runtime constant v236321','_RUNTIME_VERSION_V236321 = "23.63.21"' in main),
 ('runtime endpoint v236321','/api/runtime-identity/v236321' in main),
 ('soak endpoint v236321','/api/runtime-soak-stability/v236321' in main),
 ('force response exact v236321','"runtime_version": _RUNTIME_VERSION_V236321,\n            "test_only": True' in main),
 ('HB v236321 recovery marker','V23.63.21 HB VERIFIED SEARCH-CARD AUDIO-LAPTOP RECOVERY' in repair),
 ('HB FreeBuds exact lock','is_freebuds_se2_exact_v236321' in repair and 'score >= 338' in repair),
 ('HB MacBook Neo exact lock','is_macbook_neo_exact_v236321' in repair and 'score >= 305' in repair),
...
if failed: raise SystemExit('V23.63.21 MASTER smoke FAIL: '+', '.join(failed))
print(f'V23.63.21 MASTER smoke OK {len(checks)}/{len(checks)}')
