...
checks=[
 ('VERSION 23.63.13',(ROOT/'VERSION').read_text().strip()=='23.63.13'),
 ('VERSION.txt 23.63.13',(ROOT/'VERSION.txt').read_text().strip()=='23.63.13'),
 ('runtime constant v236313','_RUNTIME_VERSION_V236313 = "23.63.13"' in main),
 ('runtime endpoint v236313','/api/runtime-identity/v236313' in main),
 ('soak endpoint v236313','/api/runtime-soak-stability/v236313' in main),
 ('force response exact v236313','"runtime_version": _RUNTIME_VERSION_V236313,\n            "test_only": True' in main),
...
if failed: raise SystemExit('V23.63.13 MASTER smoke FAIL: '+', '.join(failed))
print(f'V23.63.13 MASTER smoke OK {len(checks)}/{len(checks)}')
